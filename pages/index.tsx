...
const projects = [
  ...
  },
  {
    ...
    description: "School management system with student, teacher, and admin dashboards with full functionalities and Payment API's ready for deployment.",
...
export default function Home() {
  ...
  const sendEmail = (e: React.FormEvent) => {
    ...
    const SERVICE_ID = 'service_ilo1exd';
    const TEMPLATE_ID = 'template_s3amlps';
    const PUBLIC_KEY = '52NgDzAIaw98krF_K';
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-xl p-8 max-w-2xl mx-auto shadow-sm">
            ...
            <form ref={formRef} onSubmit={sendEmail} className="space-y-4">
              ...
              <button 
                type="submit"
                className="w-full bg-teal-600 text-white py-3 rounded-lg hover:bg-teal-700 transition-all hover:shadow-lg font-medium"
              >
                Send Message
              </button>
            </form>
